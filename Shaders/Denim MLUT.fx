...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#define fLUT_TextureName "Denim MLUT.png"
#endif
...
namespace MLUT_MultiLUT_Denim
{
    ...
    texture texMultiLUT_MLUT_pd80_Denim < source = fLUT_TextureName; > { Width = fLUT_TileSizeXY * fLUT_TileAmount; Height = fLUT_TileSizeXY * fLUT_LutAmount; Format = RGBA8; };
    sampler	SamplerMultiLUT { Texture = texMultiLUT_MLUT_pd80_Denim; };
