...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#define fLUT_TextureName "Tranquil Purple MLUT.png"
#endif
...
namespace MLUT_MultiLUT_Tranquil_Purple
{
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    //
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    texture texMultiLUT_MLUT_pd80_Tranquil_Purple < source = fLUT_TextureName; > { Width = fLUT_TileSizeXY * fLUT_TileAmount; Height = fLUT_TileSizeXY * fLUT_LutAmount; Format = RGBA8; };
    sampler	SamplerMultiLUT { Texture = texMultiLUT_MLUT_pd80_Tranquil_Purple; };
    ...
    technique Tranquil_Purple_MLUT
    {
        pass MultiLUT_Apply
        {
